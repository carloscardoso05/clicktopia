...
// VrStereoConfig, VR stereo rendering configuracao for simulator
...
RLAPI void SetWindowState(unsigned int flags);                    // Set window configuracao state using flags (only PLATFORM_DESKTOP)
RLAPI void ClearWindowState(unsigned int flags);                  // Clear window configuracao state flags
...
RLAPI void SetConfigFlags(unsigned int flags);                    // Setup init configuracao flags (view FLAGS)
...
// Texture configuracao functions
